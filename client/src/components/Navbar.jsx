        ...
        {user ? (
            ...
            <div className="relative group">
              ...
              >
                <ul className="list-none m-0 p-2 bg-white rounded-md border text-sm">
                  <li
                    onClick={logout}
                    className="py-1 px-2 cursor-pointer pr-10 hover:bg-gray-200 rounded-md"
                  >
                    Logout
                  </li>
                </ul>
          ...
          <div className="flex items-center gap-2 sm:gap-5 ">
            ...
            <button
              ...
              className="bg-zinc-800 text-white px-7 py-2 sm:px-10 text-sm rounded-full cursor-pointer hover:bg-zinc-700 transition"
            >
              Login
            </button>
          </div>
